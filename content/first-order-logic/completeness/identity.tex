...
\olsection{fol}{com}{ide}{Identity}
...
\[
\Term{f}{t_1,\dots, t_{i-1}, t, t_{i+1}, \dots, t_n} \approx
\Term{f}{t_1,\dots, t_{i-1}, t', t_{i+1}, \dots, t_n}.
\]
...
\[
\Gamma^* \Proves
\eq[\Term{f}{t_1,\dots,t_{i-1},t,t_{i+1},,\dots,t_n}][\Term{f}{t_1,\dots,t_{i-1},t',t_{i+1},\dots,t_n}]
\]
...
\item $\Assign{f}{\equivclass{M}{\approx}}(\equivrep{t_1}{\approx}, \dots,
  \equivrep{t_n}{\approx}) = \equivrep{\Term{f}{t_1,\dots, t_n}}{\approx}$
...
\begin{enumerate}
\item $\equivrep{\Term{f}{t_1,\dots, t_n}}{\approx} =
    \equivrep{\Term{f}{t_1',\dots, t_n'}}{\approx}$, i.e.,
  \[
  \Term{f}{t_1,\dots, t_n} \approx \Term{f}{t_1',\dots, t_n'}
  \]
  and
