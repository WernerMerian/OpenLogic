...
\olsection{fol}{syn}{ass}{Variable Assignments}
...
For the inductive step, assume that $t = \Term{f}{t_1, \dots, t_k}$
and that the claim holds for $t_1$, \dots, $t_k$. Then
\begin{align*}
  \Value{t}{M}[s_1] & = \Value{\Term{f}{t_1, \dots, t_k}}{M}[s_1] \\
...
\Value{t}{M}[s_1] & = \Value{\Term{f}{t_1, \dots, t_k}}{M}[s_1] \\
  ...
  & = \Value{\Term{f}{t_1, \dots, t_k}}{M}[s_2] = \Value{t}{M}[s_2].
\end{align*}
\end{proof}
