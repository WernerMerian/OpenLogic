...
\olsection{nml}{prf}{dis}{Showing Systems are Distinct}
...
\begin{figure}[htpb]
  \centering
  \olasset{\olpath/assets/tikzpictures/normal-modal-logic/Bnot4.tikz}
...
\begin{figure}[htpb]
  \centering
  \olasset{\olpath/assets/tikzpictures/normal-modal-logic/KTBnot45.tikz}
...
\begin{figure}[t]
  \centering
  \olasset{\olpath/assets/tikzpictures/normal-modal-logic/KD5not4.tikz}
