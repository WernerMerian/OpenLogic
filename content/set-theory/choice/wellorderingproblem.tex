...
\olsection{sth}{choice}{woproblem}{The Well-Ordering Problem}
...
In \cite{Cantor1883}, Cantor expressed his support for the Axiom
...
for its general validity'' (cited in \cite{Potter2004}). But Cantor
ultimately became convinced that the ``Axiom'' was in need of proof. So
did the mathematical community. 

The problem was ``solved'' by Zermelo in \cite{Zermelo1904}. To
