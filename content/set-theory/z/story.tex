...
\olsection{sth}{z}{story}{The Story in More Detail}
...
using a very clever technique due to \cite{Scott1974}, this
assumption can be \emph{avoided} and then \emph{derived}. (This will
also explain why we should think that there is an initial stage.) We cannot go into that here; for more, see \cite{ButtonLT1}.} 
