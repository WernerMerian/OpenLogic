...
\olsection{sfr}{fun}{cmp}{Composition of Functions}
...
\begin{figure}
  \begin{subfigure}{\linewidth}
  	\centering
  	\olasset{\olpath/assets/tikzpictures/sets-functions-relations/before-composition.tikz}
  	\caption{before composition}
  \end{subfigure}
  \begin{subfigure}{\linewidth}
  	\centering
  	\olasset{\olpath/assets/tikzpictures/sets-functions-relations/after-composition.tikz}
