...
\begin{figure}
  ...
  \begin{subfigure}{0.49\linewidth}
  	\centering
  	\olasset{\olpath/assets/tikzpictures/sets-functions-relations/injective-non-surjective.tikz}
  	\caption{A non surjective application}
  \end{subfigure}
  \begin{subfigure}{0.49\linewidth}
  	\centering
  	\olasset{\olpath/assets/tikzpictures/sets-functions-relations/surjective-non-injective.tikz}
...
\begin{figure}
  \centering
  \olasset{\olpath/assets/tikzpictures/sets-functions-relations/bijective.tikz}
