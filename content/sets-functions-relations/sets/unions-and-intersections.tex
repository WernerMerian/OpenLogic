...
\olsection{sfr}{set}{uni}{Unions and Intersections}
...
\begin{figure}
  \centering
  \olasset{\olpath/assets/tikzpictures/sets-functions-relations/union.tikz}
...
\begin{figure}
  \centering
  \olasset{\olpath/assets/tikzpictures/sets-functions-relations/intersection.tikz}
...
\begin{figure}
  \centering
  \olasset{\olpath/assets/tikzpictures/sets-functions-relations/difference.tikz}
...
\todo[inline]{Symmetric difference is missing}

\begin{figure}
	\centering
	\olasset{\olpath/assets/tikzpictures/sets-functions-relations/symmetric-difference.tikz}
