...
\olsection{tur}{mac}{hal}{Halting States}
...
\begin{center}
  \olasset{\olpath/assets/tikzpictures/turing-machines/halting-state.tikz}
\end{center}
...
\begin{center}
  \olasset{\olpath/assets/tikzpictures/turing-machines/halting-state-reject.tikz}
\end{center}
\end{ex}
